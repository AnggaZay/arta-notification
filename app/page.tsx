    ...
    <a href="#contact" className="bg-[#054fa0] text-white px-4 py-2 rounded-full text-xs md:text-sm font-bold hover:bg-yellow-400 hover:text-[#054fa0] transition-all">
      ...
      <section className="pt-32 pb-16 md:pt-48 md:pb-24 px-6 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-3 md:gap-4 px-4">
          <a href="#projek" className="bg-[#054fa0] text-white px-8 py-4 rounded-2xl font-bold text-base md:text-lg shadow-lg shadow-blue-900/20">Lihat Proyek</a>
          <a href="#portfolio" className="bg-slate-100 text-slate-600 px-8 py-4 rounded-2xl font-bold text-base md:text-lg">Portfolio</a>
        </div>
      </section>

      {/* --- PROJEK --- */}
      <section id="projek" className="py-16 md:py-24 px-6 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
          <div className="group p-8 md:p-10 rounded-[32px] bg-slate-50 border border-slate-100 hover:border-[#054fa0] transition-all">
            ...
            <p className="text-sm md:text-base text-slate-500 leading-relaxed mb-6">Menjaga tampilan merk BPR Arta Utama agar tetap relevan dan berkarakter.</p>
          ...
          <div className="group p-8 md:p-10 rounded-[32px] bg-slate-50 border border-slate-100 hover:border-red-600 transition-all text-left">
            ...
            <p className="text-sm md:text-base text-slate-500 leading-relaxed mb-6">Support visual gratis untuk mitra UMKM Arta Utama.</p>
            <div className="flex flex-wrap gap-2">
      ...
      <section id="portfolio" className="py-16 md:py-24 bg-slate-50 border-y border-slate-100 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center text-3xl md:text-5xl font-black tracking-tight mb-12">Hasil Karya</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="aspect-[4/3] md:aspect-video bg-white rounded-3xl border border-slate-200 flex flex-col items-center justify-center p-6 shadow-sm">
                <div className="w-full h-full bg-slate-50 rounded-2xl flex items-center justify-center mb-4">
      ...
      <section id="contact" className="py-12 md:py-24 px-4 md:px-8">
        <div className="max-w-4xl mx-auto bg-[#054fa0] p-8 md:p-16 rounded-[40px] text-center shadow-2xl relative overflow-hidden">
          <h2 className="text-3xl md:text-5xl font-black mb-4 text-white">Start a conversation.</h2>
          <p className="text-blue-100 mb-8 text-sm md:text-base">Kirim request langsung ke workspace tim kreatif.</p>
          <textarea 
            className="w-full p-5 rounded-2xl border border-blue-800 bg-blue-900/40 text-white mb-6 h-32 md:h-40 focus:ring-4 focus:ring-yellow-400 outline-none text-sm md:text-base"
          ...
          <button 
            onClick={kirimNotif}
            className="w-full md:w-auto bg-yellow-400 text-[#054fa0] px-10 py-4 rounded-2xl font-black text-base md:text-lg hover:bg-white active:scale-95 transition-all"
          >
            Deploy Request
          </button>
